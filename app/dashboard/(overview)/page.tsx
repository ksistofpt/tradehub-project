...
export default async function Page() {
  ...
  const totalFulfilledInvoices = cardData.totalFulfilledInvoices;
  const totalAwaitingInvoices = cardData.totalAwaitingInvoices;
  const numberOfInvoices = cardData.numberOfInvoices;
  const numberOfSellers = cardData.numberOfSellers;
